package com.inqbarna.tablefixheaders.samples1;
...
public class FamilyTable extends Activity {
    ...
    public class FamilyNexusAdapter extends BaseTableAdapter {
        ...
        public FamilyNexusAdapter(Context context) {
            ...
            familys[0].list.add(new Nexus("08:00 am", "HTC", "Gingerbread", "10", "512 MB", "3.7\"", "512 MB"));
            familys[0].list.add(new Nexus("08:40 am", "Samsung", "Gingerbread", "10", "16 GB", "4\"", "512 MB"));
            familys[0].list.add(new Nexus("09:20 am", "Samsung", "Ice cream Sandwich", "15", "16 GB", "4.65\"", "1 GB"));
            familys[0].list.add(new Nexus("10:00 am", "Samsung", "Ice cream Sandwich", "15", "32 GB", "4.65\"", "1 GB"));
            familys[0].list.add(new Nexus("10;40 am", "LG", "Jelly Bean", "17", "8 GB", "4.7\"", "2 GB"));
            familys[0].list.add(new Nexus("11:50 am", "LG", "Jelly Bean", "17", "16 GB", "4.7\"", "2 GB"));
